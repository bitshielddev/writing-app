  ...
  return (
    <div className="fixed inset-0 z-50 xl:hidden">
      ...
      <div
        ...
        className={`absolute inset-y-0 flex h-dvh flex-col overflow-hidden bg-panel shadow-2xl ${
          wide
      ...
      >
        <div className="flex h-14 shrink-0 items-center justify-between border-b border-border px-4">
          ...
          <button
            ...
            className="grid size-9 place-items-center rounded-md text-muted-foreground hover:bg-muted hover:text-brand-700"
            onClick={onClose}
          >
