...
import type { OperationResult } from "../../../contracts/base.js";
...
export interface SuggestionStore {
  ...
  appendFacts(command: import("../../../domain/suggestions/aggregate.js").SuggestionCommandEnvelope,
    facts: import("../../../domain/suggestions/aggregate.js").SuggestionFact[], eventIds: string[]): {
      projection: SuggestionProjection;
      events: import("../../../domain/suggestions/aggregate.js").SequencedSuggestionFact[];
    };
